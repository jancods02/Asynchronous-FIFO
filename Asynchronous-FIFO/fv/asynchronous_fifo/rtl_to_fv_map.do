...
# Generated on: Wed Mar 18 10:25:28 IST 2026 (Wed Mar 18 04:55:28 UTC 2026)
...
set_log_file fv/asynchronous_fifo/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/asynchronous_fifo -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/linuxeda_new/c2scadence/GENUS201/tools.lnx86"
set CDN_SYNTH_ROOT      "/linuxeda_new/c2scadence/GENUS201/tools.lnx86"
set env(CW_DIR) "/linuxeda_new/c2scadence/GENUS201/tools.lnx86/lib/chipware"
set CW_DIR      "/linuxeda_new/c2scadence/GENUS201/tools.lnx86/lib/chipware"

# default is to error out when module definitions are missing
set_undefined_cell black_box -noascend -both

add_search_path /linuxeda_new/c2scadence/FOUNDRY/digital/90nm/dig/lib -library -both
read_library -liberty -both /linuxeda_new/c2scadence/FOUNDRY/digital/90nm/dig/lib/typical.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  FIFO_Memory.v rptr_handler.v wptr_handler.v synchronizer.v TOP.v
elaborate_design -golden -root {asynchronous_fifo} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/asynchronous_fifo/fv_map.v.gz
elaborate_design -revised -root {asynchronous_fifo}
...
#add_name_alias fv/asynchronous_fifo/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/asynchronous_fifo/rtl_to_fv_map.log
}
