...
build_testmode \
    -testmode	 FULLSCAN \
    -assignfile	 $WORKDIR/asynchronous_fifo.FULLSCAN.pinassign \
    -modedef	 FULLSCAN \
...
#-------------------------------------------------------------------------------
create_logic_tests \
    -experiment	 asynchronous_fifo_atpg \
    -testmode	 FULLSCAN \

check_log log_create_logic_tests_FULLSCAN_asynchronous_fifo_atpg
...
check_log log_write_vectors_FULLSCAN_asynchronous_fifo_atpg
...
check_log log_commit_tests_FULLSCAN_asynchronous_fifo_atpg
